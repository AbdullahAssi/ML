...
def generate_usernames(mod_list):
   ...
   """
   usernames = [string.replace(" ", "_") for string in mod_list]
   return usernames
...
def map_id_to_initial(employee_list):
    ...
    [IMPLEMENT ME]
        1. Use dictionary comprehension to map each employee's first initial (key) to their id (value).
    ...
    Returns:
        dict - A dictionary mapping an employee's first initial (key) to their id (value).
    """
